...
description: Visual risk profiling, mitigation, and verification.
---
...
1. Review the visual risk profile for your asset.
2. Flag abnormal conditions and assess their severity.
3. Create mitigation actions and assign owners.
4. Track actions through to completion.
5. [Verify the risk profile](../guides/risk-profiling.md) has improved.
